...
//    "pug": Dog(breed: "Pug", name: genericDogNames.randomElement()!, imageName: "pug", purchaseCost: [PriceItem(item: defaultInventory.getItemByName(itemName: "coins")!, quantity: -30), PriceItem(item: defaultInventory.getItemByName(itemName: "wrapper")!)], dp: 1),
    ...
    "gret": Dog(breed: "Golden Retriever", name: genericDogNames.randomElement()!, imageName: "goldenRetriever", purchaseCost: [PriceItem(item: defaultInventory.getItemByName(itemName: "coins")!, quantity: -250), PriceItem(item: defaultInventory.getItemByName(itemName: "wrapper")!), PriceItem(item: defaultInventory.getItemByName(itemName: "bottle cap")!), PriceItem(item: defaultInventory.getItemByName(itemName: "yellow fur")!)], dp: 2),
    
    "gshep": Dog(breed: "German Shepherd", name: genericDogNames.randomElement()!, imageName: "germanShep", purchaseCost: [PriceItem(item: defaultInventory.getItemByName(itemName: "coins")!, quantity: -300), PriceItem(item: defaultInventory.getItemByName(itemName: "brown fur")!, quantity: -3), PriceItem(item: defaultInventory.getItemByName(itemName: "black fur")!, quantity: -2)], dp: 2),
    
    "samoyed": Dog(breed: "Samoyed", name: genericDogNames.randomElement()!, imageName: "samoyed", purchaseCost: [PriceItem(item: defaultInventory.getItemByName(itemName: "coins")!, quantity: -300), PriceItem(item: defaultInventory.getItemByName(itemName: "white fur")!, quantity: -5), PriceItem(item: defaultInventory.getItemByName(itemName: "collar")!)], dp: 2),
    
    "weim": Dog(breed: "Weimaraner", name: genericDogNames.randomElement()!, imageName: "weimaraner", purchaseCost: [PriceItem(item: defaultInventory.getItemByName(itemName: "coins")!, quantity: -300), PriceItem(item: defaultInventory.getItemByName(itemName: "gray fur")!, quantity: -3), PriceItem(item: defaultInventory.getItemByName(itemName: "blanket")!), PriceItem(item: defaultInventory.getItemByName(itemName: "collar")!)], dp: 3),
    
    "husky": Dog(breed: "Husky", name: genericDogNames.randomElement()!, imageName: "husky", purchaseCost: [PriceItem(item: defaultInventory.getItemByName(itemName: "coins")!, quantity: -400), PriceItem(item: defaultInventory.getItemByName(itemName: "gray fur")!), PriceItem(item: defaultInventory.getItemByName(itemName: "white fur")!), PriceItem(item: defaultInventory.getItemByName(itemName: "screw")!, quantity: -10)], dp: 3),
    
    "dalmatian": Dog(breed: "Dalmatian", name: genericDogNames.randomElement()!, imageName: "dalmatian", purchaseCost: [PriceItem(item: defaultInventory.getItemByName(itemName: "coins")!, quantity: -500), PriceItem(item: defaultInventory.getItemByName(itemName: "white fur")!, quantity: -3), PriceItem(item: defaultInventory.getItemByName(itemName: "black fur")!), PriceItem(item: defaultInventory.getItemByName(itemName: "dog treat")!, quantity: -5)], dp: 3),
    
    "gsp": Dog(breed: "German Shorthaired Pointer", name: genericDogNames.randomElement()!, imageName: "gsp", purchaseCost: [PriceItem(item: defaultInventory.getItemByName(itemName: "coins")!, quantity: -600), PriceItem(item: defaultInventory.getItemByName(itemName: "brown fur")!, quantity: -2), PriceItem(item: defaultInventory.getItemByName(itemName: "white fur")!), PriceItem(item: defaultInventory.getItemByName(itemName: "dog tag")!), PriceItem(item: defaultInventory.getItemByName(itemName: "collar")!), PriceItem(item: defaultInventory.getItemByName(itemName: "leash")!)], dp: 3),
//    "cockerspan": Dog(breed: "Cocker Spaniel", name: genericDogNames.randomElement()!, imageName: "cockerSpaniel", purchaseCost: [PriceItem(item: defaultInventory.getItemByName(itemName: "coins")!, quantity: -50), PriceItem(item: defaultInventory.getItemByName(itemName: "bottle cap")!), PriceItem(item: defaultInventory.getItemByName(itemName: "brown fur")!)], dp: 2),
    ...
    "bullterr": Dog(breed: "Bull Terrier", name: genericDogNames.randomElement()!, imageName: "bullTerrier", purchaseCost: [PriceItem(item: defaultInventory.getItemByName(itemName: "coins")!, quantity: -1000), PriceItem(item: defaultInventory.getItemByName(itemName: "bone")!, quantity: -5), PriceItem(item: defaultInventory.getItemByName(itemName: "teddy bear")!), PriceItem(item: defaultInventory.getItemByName(itemName: "dog treat")!)], dp: 4),
