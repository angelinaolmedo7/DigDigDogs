...
let dogsDict: [String: Dog] = [
    ...
    "bc": Dog(breed: "Border Collie", name: genericDogNames.randomElement()!, imageName: "borderCollie", purchaseCost: [PriceItem(item: defaultInventory.getItemByName(itemName: "coins")!, quantity: -50), PriceItem(item: defaultInventory.getItemByName(itemName: "screw")!)], dp: 2),
    "gshep": Dog(breed: "German Shepherd", name: genericDogNames.randomElement()!, imageName: "germanShepherd", purchaseCost: [PriceItem(item: defaultInventory.getItemByName(itemName: "coins")!, quantity: -50), PriceItem(item: defaultInventory.getItemByName(itemName: "brown fur")!), PriceItem(item: defaultInventory.getItemByName(itemName: "black fur")!, quantity: -2)], dp: 2),
    "bgshep": Dog(breed: "Blonde German Shepherd", name: genericDogNames.randomElement()!, imageName: "blondeGermanShepherd", purchaseCost: [PriceItem(item: defaultInventory.getItemByName(itemName: "coins")!, quantity: -50), PriceItem(item: defaultInventory.getItemByName(itemName: "yellow fur")!, quantity: -2)], dp: 2),
    ...
    "bullterr": Dog(breed: "Bull Terrier", name: genericDogNames.randomElement()!, imageName: "bullTerrier", purchaseCost: [PriceItem(item: defaultInventory.getItemByName(itemName: "coins")!, quantity: -100), PriceItem(item: defaultInventory.getItemByName(itemName: "bone")!), PriceItem(item: defaultInventory.getItemByName(itemName: "dog tag")!), PriceItem(item: defaultInventory.getItemByName(itemName: "collar")!)], dp: 3),
